<?php 
    ...
    $sql = "SELECT id, nomComplet, mail, date, tel, module, typeCours, responsable, status, notes, attestation FROM clients WHERE attestation ='oui'";
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>database etudiants </div>
                            <div class="card-body">
                        ...
                        <div class="ajout">
                                <i class="fa fa-plus-circle"></i>Ajouter une information
                        </div>
                        <div class="buttons">
                        ...
                        <form class="form">
                            <h2><center>Veuiller remplir le formulaire la base de donnée du client</center></h2>
                            ...
                            <div class="form-row">
                                    <div class="col">
                                        ...
                                        <input type="email" class="form-control" name="Nom">
                                    </div>
                        ...
                        <div id="dialog-confirm" class="deleting-confirm">
                            <h2><center>Caisse</center></h2>
                            <ul>

                                <li class="dialog-item">
                                    <div class="item-wrap">
                                        <span class="caisse-titre">Nom</span>
                                    </div>
                                    <div class="item-wrap">
                                        <span class="caisse-content">Aria Stark</span>
                                    </div>
                                </li>
                                
                                <li class="dialog-item">
                                    <div class="item-wrap">
                                        <span class="caisse-titre">Coordonnées</span>
                                    </div>
                                    <div class="item-wrap">
                                        <span class="caisse-content">Sans visage</span>
                                    </div>
                                </li>

                                <li class="dialog-item">
                                    <div class="item-wrap">
                                        <span class="caisse-titre">Offres & Services consommées</span>
                                    </div>
                                    <div class="item-wrap">
                                        <span class="caisse-content">Achat Eau vive</span>
                                    </div>
                                </li>
