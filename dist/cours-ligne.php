<?php 
    ...
    $sql = "SELECT id, nomComplet, mail, date, tel, module, typeCours, responsable, status, notes, attestation FROM clients WHERE typeCours ='en ligne' and attestation='non'";
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>Cours en ligne </div>
                            <div class="card-body">
